...
INSERT INTO RESERVATION VALUES(132330658,'57ab', '11-Nov-2012', '23-Nov-2012', '1323RF56ab');
...
SELECT *
FROM TRAVELER LEFT OUTER JOIN RESERVATION ON
TRAVELER.ID = travelerID; -- Outter-join shows all users, even they have not reserved
